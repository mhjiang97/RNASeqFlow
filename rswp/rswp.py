...
`---'                          '---"        `---`
    ...
    ## ----- common parser ----- ##
    parser_common = parser_groups.add_argument_group(
        title=textwrap.dedent("COMMON SETTINGS"),
        description=textwrap.dedent(
            "@@@ WARNING: parameters defined in the config file will always be prior to default values @@@"
        ),
    )
    ...
    parser_common.add_argument(
        ...
        "--samples",
        nargs="+",
        metavar=("samples.txt or", "id_1 id_2"),
    ...
    parser_settings = parser_groups.add_argument_group(
        title="PATHS SETTINGS",
        description=textwrap.dedent(
            "@@@ aiming at substituting for defined paths in the config file @@@"
        ),
    )
    ...
    parser_settings.add_argument(
        "--fa", type=str, metavar="", help="a preferred fa file"
    )
    parser_settings.add_argument(
        "--suffix_fq",
        type=str,
    ...
    parser_star.add_argument(
        "--dir_index", type=str, metavar="", help="star index directory"
    )
    parser_star.add_argument(
        "--name_star_dir",
        type=str,
    ...
    parser_rsem.add_argument(
        "--prefix_reference", type=str, metavar="", help="rsem reference prefix"
    )
    parser_rsem.add_argument(
        "--name_rsem_dir",
        type=str,
    ...
    parser_salmon.add_argument(
        "--dir_index", type=str, metavar="", help="salmon index directory"
    )
    parser_salmon.add_argument(
        "--name_salmon_dir",
        type=str,
    ...
    parser_sub_rsem = subparsers.add_parser(
        "rsem",
    ...
    parser_sub_fastqc = subparsers.add_parser(
        "fastqc",
    ...
    parser_sub_samtools = subparsers.add_parser(
        "samtools",
    ...
    parser_sub_salmon = subparsers.add_parser(
        "salmon",
